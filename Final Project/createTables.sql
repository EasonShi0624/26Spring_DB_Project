...
DROP TABLE IF EXISTS card_swipe_log;
DROP TABLE IF EXISTS guest_message;
DROP TABLE IF EXISTS payment;
DROP TABLE IF EXISTS charge;
DROP TABLE IF EXISTS account_responsibility;
DROP TABLE IF EXISTS account;
DROP TABLE IF EXISTS event_room_usage;
DROP TABLE IF EXISTS event_organization;
DROP TABLE IF EXISTS event_guest;
DROP TABLE IF EXISTS event;
DROP TABLE IF EXISTS room_extension;
DROP TABLE IF EXISTS stay_room_guest;
DROP TABLE IF EXISTS stay_room_assignment;
DROP TABLE IF EXISTS reservation_bed_preference;
...
DROP TABLE IF EXISTS room_fixture;
